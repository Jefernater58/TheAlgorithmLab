    ...
    return <div className="Global-container">
        ...
        <div className="Global-mainbody">
            <div className="Pathfinding-options">
                ...
                <input onChange={setNodeCountBounds} type="number" max="50" min="2" className="Global-text-input" id="numNodes" value={nodeCount} />
                <br/>
                <button onClick={randomiseGraph} style={{float: "left"}} className="Global-button"><Shuffle size="18" style={{marginRight: "4px"}}/>Generate Graph</button>
                <br/><br/><br/>
                ...
                <input value={inputs.start} onChange={(e) => {setGraphStart(e); updateInput("start", e.target.value);}} type="text" className="Global-text-input" id="StartNode" />
                <br/>
                <label className="Global-input-label">target_node</label>
                <input value={inputs.target} onChange={(e) => {setGraphTarget(e); updateInput("target", e.target.value);}} type="text" className="Global-text-input" id="TargetNode" />
                <br/>
